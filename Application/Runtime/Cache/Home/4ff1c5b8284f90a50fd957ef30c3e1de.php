...
<head>
    ...
    <link href="/Mine/Learn/Blog/Public/Default/css/bootstrap.min.css" rel="stylesheet">
    <link href="/Mine/Learn/Blog/Public/Default/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="/Mine/Learn/Blog/Public/Default/css/animate.css" rel="stylesheet">
    <link href="/Mine/Learn/Blog/Public/Default/css/style.css" rel="stylesheet">
    <script>
        var _hmt = _hmt || [];
        (function() {
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header" style="text-align:center;">
                        ...
                        <a href="/Mine/Learn/Blog/index.php">
                            <img alt="image" class="img-circle" src="/Mine/Learn/Blog/Public/Uploads/<?php echo ($SiteInfo["logo"]); ?>" width="80px;"  height="80px;" />
                        </a>
                        </span>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>欢迎来到CarolCoral的技术博客，祝您访问愉快！<!-- <font color="#fcc00" size="1em">PS：您可以点击网页标签上的小喇叭控制音乐开关</font> --></h5><br>
                    <h2><font color="red" size="3em"><!-- 重要！！！请记住域名<a href="http://coralcarol.lofter.com" style="a:link{color:red;}">coralcarol.lofter.com</a>，无法访问请前往该域名地址，相互转告，谢谢！ -->电影、电视剧的下载链接请点击文章最下方红色字体！！！</font></h2>
                    ...
                    <div class="carousel slide" id="carousel2" >
                        ...
                        <div class="carousel-inner"  >
                            ...
                            <div class="item" ><?php endif; ?>
                               <a href="<?php echo ($vo["url"]); ?>" target="_blank"><img alt="<?php echo ($vo["title"]); ?>" class="img-responsive" src="/Mine/Learn/Blog/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="width:100%;height: 550px;"></a>
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <img alt="image" class="img-responsive" src="/Mine/Learn/Blog/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="max-height:150px;min-height:120px;">
      ...
      <a href="#0" class="cd-top">↑</a>
        <div class="footer" style="z-index:9999;">
            ...
            <div>
                ...
                <img src="/Mine/Learn/Blog/Public/Uploads/gh.png" style="width: 18px;height: 18px;margin-top: -5px;"><?php echo ($SiteInfo["icp"]); ?>
            </div>
        </div>

        </div>
        </div>
    <EMBED src="/Mine/Learn/Blog/Public/Uploads/MP3/" width='0px' height='0px' type='audio/mpeg' loop="1" autostart="true" volume="0"></EMBED>
    <script src="/Mine/Learn/Blog/Public/Default/js/jquery-2.1.1.js"></script>
    <script src="/Mine/Learn/Blog/Public/Default/js/jquery-ui-1.10.4.min.js"></script>
    <script src="/Mine/Learn/Blog/Public/Default/js/bootstrap.min.js"></script>
    <!-- 手风琴菜单 -->
    <script src="/Mine/Learn/Blog/Public/Default/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <!-- 滚动条 -->
    <script src="/Mine/Learn/Blog/Public/Default/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <!-- 导航菜单 -->
    <script src="/Mine/Learn/Blog/Public/Default/js/inspinia.js"></script>
    <!-- 进度条 -->
    <script src="/Mine/Learn/Blog/Public/Default/js/plugins/pace/pace.min.js"></script>
