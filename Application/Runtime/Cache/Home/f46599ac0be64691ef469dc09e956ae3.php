                    ...
                    <div class="ibox-content">
                        <div class="text-center article-title" style="margin:20px 0px 20px">
                            ...
                            <div style="margin-bottom:50px;">
                                <?php switch($fenleiInfo["type"]): case "1": if($articleInfo["viewtumb"] == 0): ?><img src="/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php endif; break;?>
                                    <?php case "2": ?><!-- 音乐 -->
                                        <link rel="stylesheet" href="/Public/Default/music/css/lanrenzhijia.css" type="text/css" />
                            ...
                            <script src="/Public/Default/music/js/jquery.min.js"></script>
                            <script src='/Public/Default/music/js/jquery.jplayer.min.js'></script>
                            <script src='/Public/Default/music/js/jplayer.playlist.min.js'></script>
                            <script>
                                $(document).ready(function(){
                                  ...
                                  var playlist = [{
                                      ...
                                      mp3:"/Public/Uploads/<?php echo ($articleInfo["mp3"]); ?>",
                                          //oga:"http://www.jplayer.org/audio/ogg/Miaow-02-Hidden.ogg",
                                        poster: "/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>"
                                      }];
...
<!-- 音乐 --><?php break;?>
<?php default: ?>
<?php if($articleInfo["viewtumb"] == 0): ?><img src="/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php endif; endswitch;?>
...
<div class="col-lg-3">
    <div class="widget-head-color-box navy-bg p-lg text-center" style="margin-top:0px;">
        ...
        <img src="/Public/Uploads/1.jpg" class="img-circle circle-border m-b-md" alt="profile" height="135px; " width="135px;">
    </div>
...
<script>
        $(function() {
            $("#socialShare").socialShare({
                ...
                url:'http://<?php echo $_SERVER["SERVER_NAME"];?>/index.php?m=Home&c=Article&a=index&id=106',
                titile:'<?php echo ($articleInfo["title"]); ?>-<?php echo ($SiteInfo["title"]); ?>',
                pic:'/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>'
            });
