...
<head>
    ...
    <title>搜索<?php echo ($_GET['keywords']); ?>-<?php echo ($SiteInfo["title"]); ?></title>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>搜索：<?php echo ($keywords); ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <h2>
                                <?php echo ($count); ?>个结果关于: <span class="text-navy">“<?php echo ($keywords); ?>”</span>
                            </h2>

                            <div class="search-form">
                                <form action="<?php echo U('Index/serch');?>" method="get">
                                    <div class="input-group">
                                        <input placeholder="输入搜索内容" name="keywords" class="form-control input-lg" type="text" required>
                            ...
                            <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><div class="hr-line-dashed"></div>
                            <div class="search-result">
                                <h3><a href="<?php echo U('Article/index',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></h3>
                                <p>
                                    <?php echo (msubstr(htmlspecialchars(strip_tags($vo["content"])),0,70,'utf-8',true)); ?>
                                </p>
